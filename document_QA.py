...
os.environ["OPENAI_API_KEY"] = "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"
...
def main():
    img = Image.open('/Users/mertsengil/Desktop/ARKAS/icono_empresa_ARKAS.png',)
...
# </div>""", unsafe_allow_html=True)
    ...
    st.subheader("""Select your document.
                    available documents: 1- '.../ARKAS/ARL PL Result.csv'
                         2- '.../ARKAS/Service Based Avr SF.csv' """)
